...
def api_obtener_detalle_pedido(detalle_pedido_id: int = Path(...)):
...
def api_actualizar_detalle_pedido(detalle_pedido_id: int = Path(...), body: detalle_pedidoUpdate = ...):
...
def api_eliminar_detalle_pedido(detalle_pedido_id: int = Path(...)):
